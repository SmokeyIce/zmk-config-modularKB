...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_INDICATOR_LEDS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_INDICATOR_LEDS_INIT_PRIORITY, 91);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_IDLE_SLEEP_TIMEOUT, 3600000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_INDICATOR_LEDS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZMK_KEYBOARD_MODKB_MODULE, 1);
